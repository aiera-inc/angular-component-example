...
export class AppComponent {
  ngOnInit() {
    ...
    const eventList3 = new Aiera.Module(
      'https://public.aiera.com/aiera-sdk/dev/0.0.60/modules/EventList/index.html',
      'example_iframe3'
    );
    eventList3.load().then(() => {
      eventList3.authenticateApiKey('9b9a25ca85b41fb3c136f9814e7e8105');
    });
    eventList3.on('authenticated', () => {
      setTimeout(() => {
        eventList3.configure({
          hideSettings: true,
          options: {
            showCompanyFilter: false,
            ticker: 'meta',
